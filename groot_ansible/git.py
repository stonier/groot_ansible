...
"""
Subcommand for git installation
"""
...
def parse_args(args):
    ...
    cmd = "ansible-playbook git.yaml -K -i localhost, {connection} {list_tasks}".format(**locals())
...
def add_subparser(subparsers):
    ...
    parser = subparsers.add_parser("git",
                                   description="git binaries, modules (lfs) and user configuration",  # this shows in the help for this command
                                   help="git binaries, modules and configuration",  # this shows in the parent parser
